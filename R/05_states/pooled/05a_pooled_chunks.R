# =============================================================================
# POOLED STATES, STEP A of C : SPLIT THE GRID CELLS INTO GROUPS
# Original file name: Percentiles_pooled_chunk_assignments_v2.R
# Methods 2.6
# -----------------------------------------------------------------------------
...
# Output : pooled_chunked/<zone>/<zone>_chunk_assignments.Rdata
#            (object unique_gridcells: lat, lon, chunk_id)
#          pooled_chunked/<zone>/<zone>_chunk_summary.txt
#
# Run    : Rscript 05a_pooled_chunks.R
...
output_path <- "/Net/Groups/BGI/scratch/mterristi/PhD/CWD_0_1/New_Climate_Zones_percentiles/Drydowns/Drydowns_percentiles_pooled_v2/pooled_chunked"
